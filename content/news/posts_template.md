...
```![Texte alternatif](../../assets/media/news/photo.jpg)```
Image avec légende (figure/figcaption, comme ton image World Backup Day) :

```html
<figure>
  <img src="../../assets/media/news/world-backup-day.jpeg" alt="World Backup Day">
...
```html
<video controls>
  <source src="../../assets/media/news/video.mp4" type="video/mp4">
</video>
```
...
```html
<div class="gallery">
  <img src="../../assets/media/news/1.jpg" alt="">
  <img src="../../assets/media/news/2.jpg" alt="">
</div>
```
